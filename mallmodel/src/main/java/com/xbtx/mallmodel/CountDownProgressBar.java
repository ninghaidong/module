...
public class CountDownProgressBar extends View {
     ...
     * 渐变圆周颜色数组
     */
    private int[] colorArray = new int[]{Color.parseColor("#FFBB86FC"),
            Color.parseColor("#FF6200EE"), Color.parseColor("#FF3700B3")};
    ...
    private void drawCircle(Canvas canvas, int center, int radius) {
        ...
        circlePaint.setShadowLayer(10, 10, 10, getResources().getColor(R.color.transparent));
...
//            percent = result+"秒";
     ...
     * @param duration 动画时长
     */
    public void setDuration(int duration, int start, int end, OnFinishListener listener) {
...
//        }
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                Log.e("CountDownProgressBar", "动画结束");
            }
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                //一般只是希望在View发生改变时对UI进行重绘。invalidate()方法系统会自动调用 View的onDraw()方法。
                invalidate();
                Log.e("CountDownProgressBar", "maxValue:" + maxValue);
                Log.e("CountDownProgressBar", "currentValue:" + currentValue);
