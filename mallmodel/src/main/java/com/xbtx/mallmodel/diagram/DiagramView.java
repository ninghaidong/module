...
public class DiagramView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画数值
        canvas.drawText(mHeightText, mWidth / 2 - mTextPaint.getTextSize() / 2, mCaculatedHeightY - 10, mTextPaint);
        canvas.drawText(mLowText, mWidth / 2 - mTextPaint.getTextSize() / 2, mCaculatedLowY + mTextPaint.getTextSize() + 10, mTextPaint);
